...
alias start-namenode="$HADOOP_HOME/sbin/hadoop-daemon.sh start namenode"
alias start-datanode="$HADOOP_HOME/sbin/hadoop-daemon.sh start datanode"
alias start-resmanager="$HADOOP_HOME/sbin/yarn-daemon.sh start resourcemanager"
alias start-nodemanager="$HADOOP_HOME/sbin/yarn-daemon.sh start nodemanager"
alias start-jobhistser="$HADOOP_HOME/sbin/mr-jobhistory-daemon.sh start historyserver"

alias stop-namenode="$HADOOP_HOME/sbin/hadoop-daemon.sh stop namenode"
alias stop-datanode="$HADOOP_HOME/sbin/hadoop-daemon.sh stop datanode"
alias stop-resource-manager="$HADOOP_HOME/sbin/yarn-daemon.sh stop resourcemanager"
alias stop-node-manager="$HADOOP_HOME/sbin/yarn-daemon.sh stop nodemanager"
alias stop-job-history-server="$HADOOP_HOME/sbin/mr-jobhistory-daemon.sh stop historyserver"
